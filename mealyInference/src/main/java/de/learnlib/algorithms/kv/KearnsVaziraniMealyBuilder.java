 ...
 * de.learnlib.algorithms.kv.KearnsVaziraniMealy<I,O>
 */
 ...
 public final class KearnsVaziraniMealyBuilder<
    ...
    private static<
        ...
        de.learnlib.datastructure.discriminationtree.MultiDTree dsicTree 
        ) 
        {
    ...
    protected MultiDTree<I, Word<O>, StateInfo<I, Word<O>>> discriminationTree;
     ...
     public KearnsVaziraniMealyBuilder() {
         this.repeatedCounterexampleEvaluation = de.learnlib.algorithms.kv.KearnsVaziraniMealy.BuilderDefaults.repeatedCounterexampleEvaluation();
         this.counterexampleAnalyzer = de.learnlib.algorithms.kv.KearnsVaziraniMealy.BuilderDefaults.counterexampleAnalyzer();
     }
