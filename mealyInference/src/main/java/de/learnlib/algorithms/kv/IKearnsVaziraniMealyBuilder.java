...
import net.automatalib.words.Alphabet;
 ...
 //  import de.learnlib.ds.StateInfo;
  ...
  public final class IKearnsVaziraniMealyBuilder<
     ...
     private static<
             A extends java.lang.Object,
             I extends java.lang.Object,
             O extends java.lang.Object> de.learnlib.algorithms.kv.IKearnsVaziraniMealy<I, O> $createDispatch(
         ...
         return new IKearnsVaziraniMealy< I, O>(
            alphabet,
            oracle,
     ...
     private net.automatalib.words.Alphabet<I> alphabet;
      ...
      public IKearnsVaziraniMealyBuilder<A, I, O> withDiscriminationTree(MultiDTree<I, Word<O>, StateInfo<I, Word<O>>> discriminationTree) {
          this.discriminationTree = discriminationTree;
          return this;
      }
 
      public IKearnsVaziraniMealyBuilder() {
      ...
      public IKearnsVaziraniMealyBuilder<A, I, O> withAlphabet(net.automatalib.words.Alphabet<I> alphabet) {
          this.alphabet = alphabet;
          return this;
      } 
      ...
      public IKearnsVaziraniMealyBuilder<A, I, O> withOracle(de.learnlib.api.oracle.MembershipOracle<I,net.automatalib.words.Word<O>> oracle) {
          this.oracle = oracle;
          return this;
      } 
      ...
      public IKearnsVaziraniMealyBuilder<A, I, O> withRepeatedCounterexampleEvaluation(boolean repeatedCounterexampleEvaluation) {
          this.repeatedCounterexampleEvaluation = repeatedCounterexampleEvaluation;
          return this;
      } 
      ...
      public IKearnsVaziraniMealyBuilder<A, I, O> withCounterexampleAnalyzer(de.learnlib.acex.AcexAnalyzer counterexampleAnalyzer) {
          this.counterexampleAnalyzer = counterexampleAnalyzer;
          return this;
      } 
