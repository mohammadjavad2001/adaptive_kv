 ...
 * @author falkhowar
 */
public class Experiment1<A extends Object> {
    ...
    public <I, D> Experiment1(LearningAlgorithm<? extends A, I, D> learningAlgorithm,
    ...
    public static class DFAExperiment<I> extends Experiment1<DFA<?, I>> {
    ...
    public static class MealyExperiment<I, O> extends Experiment1<MealyMachine<?, I, ?, O>> {
